    ...
    function Te(e, t, n) {
      ...
      return (
        (o || (!o && !n)) &&
          ...
          j(t) ? (((u = W(t, !0)).x += t.clientLeft), (u.y += t.clientTop)) : s && (u.x = fe(s))),
                  ...
                  return function i(r) {
                    for (var o = e.querySelectorAll(t), a = r.target; a && a !== this; a = a.parentNode) {
                      ...
                      try {
                        for (c.s(); !(s = c.n()).done; )
                          if (s.value === a)
                            return Nt(r, { delegateTarget: a }), i.oneOff && It.off(e, r.type, t, n), n.apply(a, [r]);
                      } catch (e) {
                        c.e(e);
                      } finally {
                        c.f();
            ...
            [
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  return qe(
                    qe(qe(qe({}, this.constructor.Default), 'object' === et(n) ? n : {}), ot(t) ? Wt(t) : {}),
                    'object' === et(e) ? e : {}
                  );
                }
              },
          ...
          Ue(
            ...
            [
              ...
              },
              {
                ...
                value: function (e) {
                  if (
                    'object' === et((e = Ie(He(t.prototype), '_getConfig', this).call(this, e)).reference) &&
                    !ot(e.reference) &&
              ...
              },
              {
                ...
                value: function () {
                  ...
                  'parent' === this._config.reference
                    ...
                    : 'object' === et(this._config.reference) && (e = this._config.reference);
                ...
                value: function () {
                  ...
                  return (
                    (this._inNavbar || 'static' === this._config.display) &&
                      (Ht(this._menu, 'popper', 'static'), (e.modifiers = [{ name: 'applyStyles', enabled: !1 }])),
              ...
              },
              {
                ...
                value: function (e) {
                  var t = e.key,
                    n = e.target,
                    i = Kt.find('.dropdown-menu .dropdown-item:not(.disabled):not(:disabled)', this._menu).filter(
                      function (e) {
                        return st(e);
                      }
                    );
                ...
                value: function (e) {
                  ...
                  if ((r || i) && (!n || i)) {
                    ...
                    var o = this.matches(si)
                        ? this
                        : Kt.prev(this, si)[0] || Kt.next(this, si)[0] || Kt.findOne(si, e.delegateTarget.parentNode),
    ...
    var yi = 'backdrop',
      ...
      Ai = (function (e) {
        function t(e) {
          var n;
          return (
            Ke(this, t), ((n = Ne(this, t))._config = n._getConfig(e)), (n._isAppended = !1), (n._element = null), n
          );
        }
        return (
          We(t, e),
            ...
            [
                    ...
                    if (!t.defaultPrevented && n) {
                      ...
                      if (
                        (this._element.ownerDocument.documentElement.contains(this.tip) ||
                          (r.append(i), It.trigger(this._element, this.constructor.eventName('inserted'))),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (
                    this._isShown() &&
                    !It.trigger(this._element, this.constructor.eventName('hide')).defaultPrevented
                  ) {
                  ...
                  try {
                    for (n.s(); !(e = n.n()).done; ) {
                      ...
                      if ('click' === i)
                        ...
                        var r =
                            i === jr ? this.constructor.eventName('mouseenter') : this.constructor.eventName('focusin'),
                          o =
                            i === jr
