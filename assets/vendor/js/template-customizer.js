    ...
    return (
      (function () {
                    ...
                    if (this._hasControls('themes')) {
                      ...
                      if (s) {
                        ...
                        this._loadStylesheets(
                          ...
                          (n = g(n)) in a
                            ? Object.defineProperty(a, n, { value: o, enumerable: !0, configurable: !0, writable: !0 })
                            : (a[n] = o),
                          a),
                          i || function () {}
                        ),
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    if (e !== this.settings.lang || a) {
                      ...
                      for (
                        var o = n.themes || {},
                          r = this.container.querySelectorAll('.template-customizer-theme-item') || [],
                          l = 0,
                          c = r.length;
                        l < c;
                        l++
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    '' !== i || '' !== s || '' !== a || '' !== n || '' !== o || '' !== l || '' !== u
                      ...
                      : this._showResetBtnNotification(!1),
                      (t =
                        '' !== u && -1 !== ['static', 'static-offcanvas', 'fixed', 'fixed-offcanvas'].indexOf(u)
                          ? u
                    ...
                    if (this._hasControls('rtl headerType contentLayout layoutCollapsed layoutNavbarOptions', !0)) {
                      ...
                      if (this._hasControls('contentLayout')) {
                        ...
                        this.settings.availableContentLayouts.forEach(function (t) {
                          ...
                          T.querySelector('input[value="'.concat(this.settings.contentLayout, '"]')).setAttribute(
                            'checked',
                            'checked'
                          );
                        var L = function (e) {
                      ...
                      if (this._hasControls('layoutNavbarOptions')) {
                        ...
                        this.settings.availableNavbarOptions.forEach(function (t) {
                          ...
                          I.querySelector('input[value="'.concat(this.settings.layoutNavbarOptions, '"]')).setAttribute(
                            'checked',
                            'checked'
                          );
                        var F = function (e) {
                    ...
                    setTimeout(function () {
                      ...
                      document.querySelector('.menu-vertical')
                        ...
                        : document.querySelector('.menu-horizontal') &&
                          (t._hasControls('rtl contentLayout headerType', !0) || (e && e.parentNode.removeChild(e)));
                    }, 100),
                    ...
                    function n(t, e, i) {
                      ...
                      (a = setInterval(function () {
                        try {
                          s[n] &&
                            s[n][o].length &&
                            (clearInterval(a), clearTimeout(r), e.parentNode.removeChild(e), i(!0));
                        } catch (t) {}
                      }, 10)),
        ...
        (E.STYLES = [
          ...
          (E.LANGUAGES = {
            kh: {
              panel_header: 'សថាដថាសដថ',
              panel_sub_header: 'ាសដថាសដថ',
              theming_header: 'Theming',
              style_label: 'Style (Mode)',
              theme_label: 'Themes',
              layout_header: 'ាសដថាសដថ',
            ...
            en: {
              ...
              style_label: 'Style (Mode)',
              theme_label: 'Themes',
              layout_header: 'នាយកដ្ឋានសវនកម្មទី២',
              layout_label: 'Menu (Navigation)',
              layout_header_label: 'Header Types',
              content_label: 'Content',
              layout_navbar_label: 'Navbar Type',
