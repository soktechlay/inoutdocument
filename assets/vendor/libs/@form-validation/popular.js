                ...
                return (
                        ...
                        return Promise.all(
                          ...
                          switch (!0) {
                            ...
                            case -1 !== t.indexOf('NotValidated'):
                              return (
                                e.emit('core.form.notvalidated', { formValidation: e }), Promise.resolve('NotValidated')
                              );
                            default:
                      ...
                      : Promise.all(
                          ...
                          switch (!0) {
                            case -1 !== n.indexOf('Invalid'):
                              return (
                                t.emit('core.field.invalid', e), t.results.set(e, 'Invalid'), Promise.resolve('Invalid')
                              );
                  ...
                  (e.prototype.validateElement = function (e, t) {
                    ...
                    return this.waterfall(o)
                      ...
                      .catch(function (r) {
                        return (
                          n.emit('core.element.notvalidated', { element: t, elements: i, field: e }), Promise.resolve(r)
                        );
                      });
                  }),
              ...
              o = (function (e) {
                ...
                return (
                        ...
                        (this.core.registerPlugin(
                          ...
                          new t.Message({
                            ...
                            container: function (e, i) {
                              var o =
                                  'string' == typeof n.opts.rowSelector ? n.opts.rowSelector : n.opts.rowSelector(e, i),
                                a = r(i, o);
                  ...
                  (o.prototype.prepareElementContainer = function (e, t) {
                    var n,
                      o =
                        'string' == typeof this.opts.rowSelector ? this.opts.rowSelector : this.opts.rowSelector(e, t),
                      a = r(t, o);
                    a !== t &&
                ...
                return (
                  ...
                  (i.prototype.install = function () {
                    ...
                    (this.tip = document.createElement('div')),
                      n(
                        this.tip,
                        (((e = { 'fv-plugins-tooltip': !0 })['fv-plugins-tooltip--'.concat(this.opts.placement)] = !0),
                        e)
                      ),
