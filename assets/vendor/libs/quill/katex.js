              ...
              return (function () {
                  ...
                  ne = (function () {
                    ...
                    return (
                      (t.toNode = function () {
                        ...
                        return (
                          this.alternate ? e.setAttribute('d', this.alternate) : e.setAttribute('d', q[this.pathName]),
                          e
                        );
                      }),
                      (t.toMarkup = function () {
                ...
                for (var He = '', Oe = 0; Oe < 52; Oe++) {
                  ...
                  ce(me, pe, ye, Ee, (He = String.fromCharCode(55349, 56320 + Oe))),
                    ...
                    ce(ue, pe, ze, Ee, He),
                    Oe < 26 &&
                      (ce(me, pe, ye, Ee, (He = String.fromCharCode(55349, 56632 + Oe))),
                      ce(ue, pe, ze, Ee, He),
                ...
                var Fe = [
                    ...
                    makeOrd: function (e, t, r) {
                      ...
                      if (l) {
                        ...
                        if ('boldsymbol' === l) {
                          ...
                          s
                            ? ((u = Ke[l].fontName), (p = [l]))
                            : ((u = Ze(l, t.fontWeight, t.fontShape)), (p = [l, t.fontWeight, t.fontShape]));
                  ...
                  nt = {
                    ...
                    mpunct: { mord: et, mop: et, mrel: rt, mopen: et, mclose: et, mpunct: et, minner: et },
                    minner: { mord: et, mop: et, mbin: tt, mrel: rt, mopen: et, mpunct: et, minner: et }
                  },
                  at = {
                    mord: { mop: et },
                    mop: { mord: et, mop: et },
                ...
                var ct = function (e) {
                  ...
                  ft = { display: A.DISPLAY, text: A.TEXT, script: A.SCRIPT, scriptscript: A.SCRIPTSCRIPT },
                  gt = {
                    mord: 'mord',
                    mop: 'mop',
                    mbin: 'mbin',
                ...
                function zt(e, t) {
                  ...
                  for (var i, o = [], s = [], l = 0; l < a.length; l++)
                    if ((s.push(a[l]), a[l].hasClass('mbin') || a[l].hasClass('mrel') || a[l].hasClass('allowbreak'))) {
                      ...
                      a[l].hasClass('newline') && (s.pop(), s.length > 0 && (o.push(Mt(s, t)), (s = [])), o.push(a[l]));
                ...
                var Lt = function (e) {
                  ...
                  Gt = function (e, t) {
                    var r = (function () {
                        ...
                        return { span: Qe.makeSpan(['stretchy'], f, t), minWidth: b, height: x };
                      })(),
                      n = r.span,
                      a = r.minWidth,
                      i = r.height;
                ...
                var Wt = function (e, t) {
                    ...
                    if (n.isStretchy)
                        ...
                        (l = Qe.makeVList(
                          {
                            ...
                            children: [
                              { type: 'elem', elem: i },
                              {
                                ...
                                wrapperStyle:
                                  o > 0 ? { width: 'calc(100% - ' + W(2 * o) + ')', marginLeft: W(2 * o) } : void 0
                              }
                            ]
                          },
                          t
                      ...
                      '\\vec' === n.label
                        ...
                        : (((m = ie((m = Qe.makeOrd({ mode: n.mode, text: n.label }, t, 'textord')))).italic = 0),
                          (d = m.width),
                          h && (c += m.depth)),
                    ...
                    return a
                      ? ((a.children[0] = v), (a.height = Math.max(v.height, a.height)), (a.classes[0] = 'mord'), a)
                      : v;
                  },
                  _t = function (e, t) {
                ...
                lt({
                  ...
                  lt({
                    ...
                    handler: function (e, t) {
                      ...
                      return { type: 'mclass', mode: n.mode, mclass: r, body: [l], isCharacterBox: p(l) };
                    },
                    htmlBuilder: Kt,
                    mathmlBuilder: Jt
                  }),
                ...
                lt({
                  ...
                  lt({
                    ...
                    htmlBuilder: function (e, t) {
                      ...
                      return (
                        e.newLine && (r.classes.push('newline'), e.size && (r.style.marginTop = W(X(e.size, t)))), r
                      );
                    },
                    mathmlBuilder: function (e, t) {
                      ...
                      return (
                        e.newLine &&
                          (r.setAttribute('linebreak', 'newline'), e.size && r.setAttribute('height', W(X(e.size, t)))),
                        r
                      );
                    }
                  });
                ...
                lt({
                  ...
                  lt({
                    ...
                    htmlBuilder: function (e, t) {
                      Hr(e);
                      for (
                        var r, n, a = vt(e.body, t, !0, ['mopen', 'mclose']), i = 0, o = 0, s = !1, l = 0;
                        l < a.length;
                        l++
                      )
                      ...
                      /box/.test(o)
                        ...
                        (r = (function (e, t, r, n, a) {
                          ...
                          if (/fbox|color|angl/.test(t)) {
                            ...
                            var l = [];
                            /^[bx]cancel$/.test(t) &&
                              l.push(new ae({ x1: '0', y1: '0', x2: '100%', y2: '100%', 'stroke-width': '0.046em' })),
                              /^x?cancel$/.test(t) &&
                                l.push(new ae({ x1: '0', y1: '100%', x2: '100%', y2: '0', 'stroke-width': '0.046em' }));
                ...
                var jr = function (e, t) {
                    ...
                    for (a = 0, q = 0; a < s || q < I.length; ++a, ++q) {
                      for (var P = I[q] || {}, V = !0; 'separator' === P.type; ) {
                        if (
                          (V ||
                            (((N = Qe.makeSpan(['arraycolsep'], [])).style.width = W(t.fontMetrics().doubleRuleSep)),
                            R.push(N)),
                  ...
                  Dr({
                    ...
                    handler: function (e) {
                      ...
                      return (
                        ...
                        t
                          ? { type: 'leftright', mode: e.mode, body: [o], left: t[0], right: t[1], rightColor: void 0 }
                          : o
                      );
                    },
                    htmlBuilder: jr,
                                ...
                                if (
                                  ...
                                  for (var d = 0; d < 2; d++) {
                                    for (var f = !0, g = m + 1; g < h.length; g++) {
                                      if (
                                        ((i = u), ('mathord' === (a = h[g]).type || 'atom' === a.type) && a.text === i)
                                      ) {
                                        (f = !1), (m = g);
                                        break;
                                      }
                  ...
                  nn = function (e, t) {
                    ...
                    if (
                      ...
                      u - o.depth - (x + 0.5 * c) < p && (u += p - (u - o.depth - (x + 0.5 * c))),
                        x - 0.5 * c - (y.height - d) < p && (d += p - (x - 0.5 * c - (y.height - d))),
                        (f = Qe.makeVList(
                          {
                            positionType: 'individualShift',
                            children: [
                    ...
                    return (
                      ...
                      (v =
                        null == e.leftDelim
                          ? kt(t, ['mopen'])
                          : qr.customSizedDelim(e.leftDelim, g, !0, t.havingStyle(n), e.mode, ['mopen'])),
                      (b = e.continued
                        ? Qe.makeSpan([])
                        : null == e.rightDelim
                        ? kt(t, ['mclose'])
                        : qr.customSizedDelim(e.rightDelim, g, !0, t.havingStyle(n), e.mode, ['mclose'])),
                ...
                var ln = function (e, t) {
                  var r,
                    ...
                    a = t.style;
                  'supsub' === e.type
                    ? ((r = e.sup ? St(e.sup, t.havingStyle(a.sup()), t) : St(e.sub, t.havingStyle(a.sub()), t)),
                ...
                lt({
                  ...
                  lt({
                    ...
                    handler: function (e, t) {
                      return { type: 'htmlmathml', mode: e.parser.mode, html: mt(t[0]), mathml: mt(t[1]) };
                    },
                    htmlBuilder: function (e, t) {
                      var r = vt(e.html, t, !1);
                      return Qe.makeFragment(r);
                    ...
                    handler: function (e, t) {
                      ...
                      if (r.settings.strict) {
                        ...
                        i
                          ...
                          : o &&
                            r.settings.reportNonstrict('mathVsTextUnits', "LaTeX's " + n + " doesn't support mu units");
                      }
                ...
                var mn = function (e, t, r, n, a, i, o) {
                  ...
                  pn = function (e, t) {
                    ...
                    return (
                      ...
                      i ? mn(o, r, n, t, s, b, v) : (v && ((o.style.position = 'relative'), (o.style.top = W(v))), o)
                    );
                  },
                  dn = function (e, t) {
                    var r;
                    if (e.symbol)
                      (r = new Tt('mo', [qt(e.name, e.mode)])), l(un, e.name) && r.setAttribute('largeop', 'false');
                ...
                lt({
                  ...
                  lt({
                    ...
                    handler: function (e, t) {
                      var r = e.parser,
                        n = t[0];
                      return { type: 'op', mode: r.mode, limits: !1, parentIsSupSub: !1, symbol: !1, body: mt(n) };
                    },
                    htmlBuilder: pn,
                    mathmlBuilder: dn
                  });
                ...
                lt({
                  ...
                  lt({
                    ...
                    htmlBuilder: function (e, t) {
                      ...
                      return (
                        (r = Qe.makeVList({ positionType: 'firstBaseline', children: [{ type: 'elem', elem: r }] }, t)),
                ...
                var xn = { display: A.DISPLAY, text: A.TEXT, script: A.SCRIPT, scriptscript: A.SCRIPTSCRIPT };
                lt({
                  type: 'styling',
                ...
                Vr('\\noexpand', function (e) {
                  var t = e.popToken();
                  return (
                    e.isExpandable(t.text) && ((t.noexpand = !0), (t.treatAsRelax = !0)), { tokens: [t], numArgs: 0 }
                  );
                }),
                ...
                var ea = function (e, t, r) {
                  ...
                  ra = {
                    ...
                    __defineFunction: lt,
                    __defineMacro: Vr,
                    __domTree: { Span: K, Anchor: J, SymbolNode: te, SvgNode: re, PathNode: ne, LineNode: ae }
                  };
                return t.default;
              })();
            }),
