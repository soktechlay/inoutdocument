                        ...
                        i(function () {
                          ...
                          ? function (e, t) {
                              for (var n = s(e), i = arguments.length, c = 1, f = a.f, p = u.f; i > c; )
                                for (
                                  var h, d = l(arguments[c++]), v = f ? o(d).concat(f(d)) : o(d), y = v.length, g = 0;
                                  y > g;
                      ...
                      (u[h] = !0),
                        (e.exports =
                          ...
                          function (e, t) {
                            var n;
                            return (
                              null !== e ? ((d[f] = i(e)), (n = new d()), (d[f] = null), (n[h] = e)) : (n = y()),
                              void 0 === t ? n : o(n, t)
                            );
                          });
                    },
                          ...
                          (e.exports = function (e, t, n) {
                            ...
                            P
                              ...
                              : ((y = t(function (e, t, n, r) {
                                  ...
                                  for (
                                    R(e, { buffer: i, byteOffset: f, byteLength: a, length: s, view: new z(i) });
                                    c < s;
                          ...
                          for (
                            ...
                            switch (((a = o[p]), c)) {
                              ...
                              case Ee:
                                n || '#' != a
                                  ? a != r &&
                                    ("'" == a && X(e) ? (e.query += '%27') : (e.query += '#' == a ? '%23' : $(a, H)))
                                  : ((e.fragment = ''), (c = ke));
                                break;
                              case ke:
                                a != r && (e.fragment += $(a, Y));
                  ...
                  (function () {
                    ...
                    var u = {
                      ...
                      fallback: function () {
                        ...
                        e ||
                          ((e = m.createElement('<div class="dz-message"><span></span></div>')),
                    ...
                    var m = (function (e) {
                      ...
                      function o(e, t) {
                        ...
                        if (
                          (null == n.options.url && (n.options.url = n.element.getAttribute('action')), !n.options.url)
                        )
                          ...
                          [
                                      ...
                                      events: {
                                        click: function (n) {
                                          return (
                                            (t !== e.element ||
                                              n.target === e.element ||
                                              o.elementInside(n.target, e.element.querySelector('.dz-message'))) &&
                            ...
                            },
                            {
                              ...
                              value: function (e, t, n, r, i) {
                                ...
                                return this.createThumbnail(e, t, n, r, !0, function (t, n) {
                                  ...
                                  return (
                                    ('image/jpeg' !== r && 'image/jpg' !== r) || (u = E.restore(e.dataURL, u)),
                                    i(o.dataURItoBlob(u))
                                  );
                                });
                              }
                            ...
                            },
                            {
                              ...
                              value: function (e) {
                                ...
                                return (
                                  this.options.uploadMultiple && this.emit('processingmultiple', e), this.uploadFiles(e)
                                );
                              }
                            },
                            {
                              ...
                              value: function (e) {
                                ...
                                this._transformFiles(e, function (n) {
                                  if (t.options.chunking) {
                                    var r = n[0];
                                    (e[0].upload.chunked =
                                      t.options.chunking && (t.options.forceChunking || r.size > t.options.chunkSize)),
                                  ...
                                  if (e[0].upload.chunked) {
                                    ...
                                    for (var l = [], c = 0; c < e.length; c++)
                                      l[c] = { name: t._getParamName(c), data: n[c], filename: e[c].upload.filename };
                                    t._uploadData(e, l);
                                  }
                                });
                              }
                              ...
                              value: function (e, t) {
                                ...
                                if (this.options.params) {
                                  ...
                                  for (var v in ('function' == typeof d &&
                                    (d = d.call(this, e, i, e[0].upload.chunked ? this._getChunk(e[0], i) : null)),
                                  d)) {
                                    var y = d[v];
