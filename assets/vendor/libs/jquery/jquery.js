                        ...
                        : function (t, n, u) {
                            ...
                            if (g) {
                              ...
                              if (((d = [a ? g.firstChild : g.lastChild]), a && x)) {
                                ...
                                (x && (b = p = (l = (c = t[y] || (t[y] = {}))[e] || [])[0] === m && l[1]), !1 === b)
                              )
                                for (
                                  ;
                                  (f = (++p && f && f[h]) || (b = p = 0) || d.pop()) &&
                  ...
                  if ((i = t.relative[e[l].type])) d = [pe(de(d), i)];
                    ...
                    if ((i = t.filter[e[l].type].apply(null, e[l].matches))[y]) {
                      ...
                      return ge(
                        l > 1 && de(d),
                        l > 1 &&
                          fe(e.slice(0, l - 1).concat({ value: ' ' === e[l - 2].type ? '*' : '' })).replace(L, '$1'),
                        i,
                        l < o && ve(e.slice(l, o)),
                        o < a && ve((e = e.slice(o))),
                        o < a && fe(e)
                                ...
                                : function () {
                                    try {
                                      ...
                                      E.Deferred.exceptionHook && E.Deferred.exceptionHook(r, c.error),
                                        e + 1 >= o && (n !== Q && ((s = void 0), (u = [r])), t.rejectWith(s, u));
                                    }
                                  };
                            e
                              ? c()
                ...
                if (((r = 'data-' + t.replace(ce, '-$&').toLowerCase()), 'string' == typeof (n = e.getAttribute(r)))) {
                  try {
                    n = (function (e) {
                      return (
                        'true' === e ||
                        ('false' !== e && ('null' === e ? null : e === +e + '' ? +e : le.test(e) ? JSON.parse(e) : e))
                      );
                    })(n);
                  } catch (e) {}
                  ue.set(e, t, n);
