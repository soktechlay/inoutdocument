    ...
    var t = {
        840: function (t, e, n) {
          ...
          !(function (r, s, o, a) {
            ...
            r.MSPointerEvent &&
              !r.PointerEvent &&
              ((dt = 'MSPointerDown'), (mt = 'MSPointerMove MSPointerUp MSPointerCancel')),
              b(gt, et, {
                handler: function (t) {
                  var e = this.store,
                    n = !1,
            ...
            function St(t, e) {
              ...
              for (r = 0; r < o.length; )
                i[o[r].identifier] && a.push(o[r]), e & (L | H) && delete i[o[r].identifier], r++;
              ...
              b(Gt, Vt, {
                ...
                directionTest: function (t) {
                  ...
                  return (
                    r & e.direction ||
                      (e.direction & $
                        ? ((r = 0 === s ? U : s < 0 ? V : G), (n = s != this.pX), (i = Math.abs(t.deltaX)))
                        : ((r = 0 === o ? U : o < 0 ? Z : B), (n = o != this.pY), (i = Math.abs(t.deltaY)))),
                    (t.direction = r),
                ...
                emit: function (t) {
                  8 === this.state &&
                    (t && t.eventType & L
                      ...
                      : ((this._input.timeStamp = v()), this.manager.emit(this.options.event, this._input)));
                }
              }),
              b($t, Vt, {
