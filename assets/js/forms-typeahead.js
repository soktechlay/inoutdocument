...
$(function () {
  ...
  $('.typeahead-multi-datasets').typeahead(
    { hint: !isRtl, highlight: !0, minLength: 0 },
    {
      ...
      source: e,
      display: 'team',
      templates: { header: '<h4 class="league-name border-bottom mb-0 mx-3 mt-3 pb-2">NBA Teams</h4>' }
    },
    {
      name: 'nhl-teams',
      source: a,
      display: 'team',
      templates: { header: '<h4 class="league-name border-bottom mb-0 mx-3 mt-3 pb-2">NHL Teams</h4>' }
    }
  );
});
