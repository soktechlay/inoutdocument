  ...
  formAuthentication &&
    FormValidation.formValidation(formAuthentication, {
      fields: {
        ...
        request_name: { validators: { notEmpty: { message: 'សូមបំពេញឈ្មោះសំណើ' } } },
        description: { validators: { notEmpty: { message: 'សូមបញ្ចូលមតិយោបល់' } } },
        new_file: { validators: { notEmpty: { message: 'សូមបញ្ចូលមតិយោបល់' } } },
        formValidationPass: {
