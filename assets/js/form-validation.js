      ...
      const t = document.getElementById('formValidationExamples'),
        ...
        r = FormValidation.formValidation(t, {
          fields: {
            ...
            formValidationPass: { validators: { notEmpty: { message: 'សូមបញ្ចូលពាក្យសម្ងាត់ថ្មី។' } } },
            formValidationConfirmPass: {
              validators: {
                notEmpty: { message: 'សូមបញ្ជាក់ពាក្យសម្ងាត់ថ្មី។' },
                identical: {
                  compare: function () {
                    return t.querySelector('[name="formValidationPass"]').value;
                  },
                  message: 'បញ្ជាក់ពាក្យសម្ងាត់មិនដូចគ្នានិងពាក្យសម្ងាត់ថ្មី។'
                }
              }
            },
