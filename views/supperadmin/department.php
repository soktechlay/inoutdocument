                ...
                <tbody class='table-border-bottom-0'>
                    <?php foreach ($results as $result) { ?>
                        <tr>
                            ...
                            <td><span class="fw-medium"><?php echo htmlentities($result->HeadUnitFullName ?? '') ?></span></td>
                            <td><span class="fw-medium"><?php echo htmlentities($result->DepHeadUnitFullNames ?? '') ?></span></td>
                            <td><span class="fw-medium"><?php echo htmlentities($result->HeadFullName ?? '') ?></span></td>
                            <td><span class="fw-medium"><?php echo htmlentities($result->DepHeadFullNames ?? '') ?></span></td>
                            <td><?php echo htmlentities($result->CreationDate ?? '') ?></td>
                            <td><?php echo htmlentities($result->UpdateAt ?? '') ?></td>
                            <td class="d-flex align-items-center justify-content-end">
                                <div class="d-inline-block text-nowrap">
                                    <a href="department-edit.php?depid=<?php echo htmlentities($result->id ?? '') ?>" class="btn text-primary btn-sm btn-icon btn-edit">
