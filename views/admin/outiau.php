...
$sql = "SELECT * FROM outdocument o
        ...
        WHERE o.isdelete = 0 
        AND o.permissions = 1"; // Corrected the table alias and permissions field
            ...
            <div class="d-flex align-items-center justify-content-between">
                <div class="card-header">
                    <h4 class="py-3 mb-1 text-primary"><span
                            class="text-muted fw-light ">អង្គភាពសវនកម្មផ្ទៃក្នុង/</span>ឯកសារចេញ</h4>
                </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-inline-block text-truncate" style="max-width:180px;"
                                                            ...
                                                            <?php echo htmlentities($row['OutDepartment']); ?>
                                                        </div>
                                                    </td>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="mb-3 col-md-6">
                                                                            <label for="nameofgive"
                                                                                class="form-label">ឈ្មោះមន្រ្តីប្រគល់</label>
                                                                            <input class="form-control" type="text"
                                                                            ...
                                                                            <div class="input-group">
                                                                                <div class="input-group-append">
                                                                                    <div
                                                                                        ...
                                                                                        <a href="../../uploads/file/out-doc/<?php echo htmlentities($row['Typedocument']); ?>"
                                                                                            target="_blank"
