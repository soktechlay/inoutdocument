...
if ($documentType === 'outdocument') {
    ...
    // Check if any non-empty row exists
    if (!empty($searchResults)) {
        $header = ['**ល.រ**', '**លេខឯកសារ**', '**កម្មវត្តុ**', '**មកពីស្ថាប័នឬក្រសួង**', '**ឈ្មោះមន្រ្តីប្រគល់**', '**ឈ្មោះមន្រ្តីទទួល**', '**ប្រភេទឯកសារចូល**', '**ប្រភេទឯកសារចំណារ**', '**ឈ្មោះនាយកដ្ឋានទទួលបន្ទុក**', '**ឈ្មោះមន្រ្តីទទួលបន្ទុក**', '**កាលបរិច្ឆេទ**'];
