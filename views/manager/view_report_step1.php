        ...
        <div class="row mb-3 align-items-center">
          ...
          <div class="col-12 col-lg-6 text-lg-end">
            ...
            <ul class="dropdown-menu" aria-labelledby="exportDropdown">
              <li><a class="dropdown-item" href="../../controllers/export1.php?id=<?php echo $getid; ?>&regulator=<?php echo $getregulator; ?>&type=word"><i class="bx bxs-file-export me-2"></i> Export to Word</a></li>
