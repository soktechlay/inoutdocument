...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (isset($_POST['delete'])) {
    ...
    if ($query->rowCount() > 0) {
      header("Location: outaudit1.php?msg=Successfully+Deleted&status=success");
      exit();
    } else {
      header("Location: outaudit1.php?msg=Error:+Something+went+wrong&status=failed");
      exit();
    }
  ...
  WHERE ID = ?");
    ...
    if ($query->rowCount() > 0) {
      header("Location: showoutaudit1.php?ID=" . urlencode($id) . "&msg=Successfully+Edited&status=success");
      exit();
    } else {
      header("Location: showoutaudit1.php?ID=" . urlencode($id) . "&msg=Error+Edited&status=failed");
      exit();
    }
  }
}
          ...
          <form id="formAccountSettings" method="post">
            <div class="row">
              ...
              ?>
                ...
                <div class="mb-3 col-md-6">
                  <label for="nameofreceive" class="form-label">ឈ្មោះអមន្រ្តីទទួល</label>
                ...
                <div class="mb-3 col-md-6">
                  <label for="nameofgive" class="form-label">ឈ្មោះអមន្រ្តី​ប្រគល់</label>
