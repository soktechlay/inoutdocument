...
$sql = "SELECT * FROM outdocument o
        ...
        WHERE o.isdelete = 0 
        AND o.permissions = 7"; // Corrected the table alias and permissions field
            ...
            <div class="d-flex align-items-center justify-content-between">
                <div class="card-header">
                    <h4 class="py-3 mb-1 text-primary"><span
                            class="text-muted fw-light ">ការិយាល័យគ្រប់គ្រងព័ត៌មានវិទ្យា/</span>ឯកសារចេញ</h4>
                </div>
            </div>
            <div class="card mb-4">
                <div class="card-body">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="mb-3 col-md-6">
                                                                            <label for="fromdepartment"
                                                                                class="form-label">ទទួលពីការិយាល័យ</label>
                                                                            <input class="form-control" type="text"
