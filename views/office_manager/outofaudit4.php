...
$sql = "SELECT * FROM outdocument o
        ...
        WHERE o.isdelete = 0 
        AND o.permissions = 11"; // Corrected the table alias and permissions field
            ...
            <div class="d-flex align-items-center justify-content-between">
                <div class="card-header">
                    <h4 class="py-3 mb-1 text-primary"><span
                            class="text-muted fw-light ">ការិយាល័យសវនកម្មទី៤/</span>ឯកសារចេញ</h4>
                </div>
            </div>
            <div class="card mb-4">
                <div class="card-body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class=" d-inline-block text-truncate" style="max-width:180px;"
                                                            ...
                                                            <?php echo $row['OutDepartment'] ?></div>
                                                    </td>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="mb-3 col-md-6">
                                                                            <label for="fromdepartment"
                                                                                class="form-label">ចេញពីការិយាល័យ</label>
                                                                            <input class="form-control" type="text"
