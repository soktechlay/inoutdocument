...
if ($documentType === 'outdocument') {
    ...
    if (!empty($searchResults)) {
        $header = ['**ល.រ**', '**លេខឯកសារ**', '**កម្មវត្តុ**', '**ចេញទៅស្ថាប័នឬក្រសួង**', '**ឈ្មោះអ្នកទទួល**', '**ឈ្មោះអ្នក​ប្រគល់**', '**មកពីនាយកដ្ឋាន**', '**ប្រភេទឯកសារចេញ**', '**កាលបរិច្ឆេទ**'];
    ...
    // Check if any non-empty row exists
    if (!empty($searchResults)) {
        $header = ['**ល.រ**', '**លេខឯកសារ**', '**កម្មវត្តុ**', '**មកពីស្ថាប័នឬក្រសួង**', '**ឈ្មោះអ្នកប្រគល់**', '**ឈ្មោះអ្នកទទួល**', '**ប្រភេទឯកសារចូល**', '**ប្រភេទឯកសារចំណារ**', '**ឈ្មោះនាយកដ្ឋានទទួលបន្ទុក**', '**ឈ្មោះអ្នកទទួលបន្ទុក**', '**កាលបរិច្ឆេទ**'];
