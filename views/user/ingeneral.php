...
$pageTitle = "ឯកសារចូលនាយកដ្ឋានកិច្ចការទូទៅ";
$sidebar = "general";
...
if (isset($_POST['edit'])) {
  ...
  if ($query->rowCount() > 0) {
    header("Location: ingeneral.php?ID=" . urlencode($id) . "&msg=Successfully+Edited&status=success");
    exit();
  } else {
    header("Location: ingeneral.php?ID=" . urlencode($id) . "&msg=Error+Edited&status=failed");
    exit();
  }
}
    ...
    <div class="container-xl flex-grow-1">
      <div class="d-flex align-items-center justify-content-between">
        <div class="card-header">
          <h4 class="py-3 mb-1 text-primary"><span class="text-muted fw-light ">នាយកដ្ឋានកិច្ចការទូទៅ/</span>ឯកសារចូល
          </h4>
        </div>
                      ...
                      foreach ($searchResults as $row) {
                        ...
                        <tr>
                          ...
                          <td><a class="btn-link link-primary"
                              href="sendoffice.php?ID=<?php echo htmlentities($row['ID']); ?>">ផ្ទេរឯកសារ</a></td>
