...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit"])) {
  ...
  if ($query_check->rowCount() > 0) {
    ...
    header("Location: outgeneral.php?msg=" . urlencode($error) . "&status=error");
    exit();
  } else {
    ...
    if (move_uploaded_file($file_tmp, $destination)) {
      ...
      try {
        ...
        header("Location: outgeneral.php?msg=" . urlencode($msg) . "&status=success");
        exit();
    ...
    <div class="container-xl flex-grow-1">
      <div class="d-flex align-items-center justify-content-between">
        <div class="card-header">
          <h4 class="py-3 mb-1 text-primary"><span class="text-muted fw-light ">នាយកដ្ឋានកិច្ចការទូទៅ/</span>ឯកសារចេញ</h4>
        </div>
