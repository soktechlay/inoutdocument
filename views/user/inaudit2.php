...
$pageTitle = "ឯកសារចូលនាយកដ្ឋានសវនកម្មទី២";
$sidebar = "audit2";
...
if (isset($_POST['edit'])) {
  ...
  if ($query->rowCount() > 0) {
    header("Location: inaudit2.php?ID=" . urlencode($id) . "&msg=Successfully+Edited&status=success");
    exit();
  } else {
    header("Location: inaudit2.php?ID=" . urlencode($id) . "&msg=Error+Edited&status=failed");
    exit();
  }
}
    ...
    <div class="container-xl flex-grow-1">
      <div class="d-flex align-items-center justify-content-between">
        <div class="card-header">
          <h4 class="py-3 mb-1 text-primary"><span class="text-muted fw-light ">នាយកដ្ឋានសវនកម្មទី២/</span>ឯកសារចូល</h4>
        </div>
              ...
              <div class="modal-dialog modal-xl modal-dialog-centered">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form method="POST" class="row g-3 needs-validation" name="example" enctype="multipart/form-data"
                      novalidate>
                      <div class="row">
                    ...
                    if (!empty($searchResults)) {
                      ...
                      foreach ($searchResults as $row) {
                        ...
                        <tr>
                          ...
                          <td><a href="../../uploads/file/in-doc/<?php echo $row['Typedocument']; ?>" target="blank_"
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="mb-3 col-md-6">
                                      ...
                                      <input class="form-control" type="text" id="burden" name="burden"
                                        value="<?php echo htmlentities($row['NameRecipient']) ?>" disabled>
                                    </div>
                                  </div>
                                  <div class="mt-2">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="mb-3 col-md-6">
                                      ...
                                      <div class="input-group input-group-merge">
                                        <span id="basic-icon-default-company2" class="input-group-text"><i
                                            class='bx bxs-business'></i></span>
                                        <select class="custom-select form-control form-select rounded-2" name="echonomic"
                                          required>
                                          <option value="<?php echo htmlentities($row['DepartmentName']); ?>">
                                            <?php echo htmlentities($row['DepartmentName']); ?></option>
                                          <?php
                                          $sql = "SELECT * FROM tbldepartments";
                                          $query = $dbh->prepare($sql);
                                          $query->execute();
