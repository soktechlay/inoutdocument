...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit"])) {
    ...
    if ($query_check->rowCount() > 0) {
        ...
        if (move_uploaded_file($file_tmp, $destination)) {
            ...
            $sql = "INSERT INTO outdocument (CodeId, Type, OutDepartment, NameOfgive, Typedocument, NameOFReceive, FromDepartment, Date, user_id, Department)
                VALUES (:code, :type, :outdepartment, :nameofgive, :file_name, :nameofreceive, :fromdepartment, :date, :userid, :department)";
...
if (isset($_POST['edit'])) {
    ...
    // Check if 'current_file' exists in the POST data
    $uploadedFile = isset($_POST['current_file']) ? $_POST['current_file'] : null;
    ...
    if (isset($_POST['edit'])) {
        ...
        if ($query->rowCount() > 0) {
            header("Location: outiau.php?ID=" . urlencode($id) . "&msg=Successfully+Edited&status=success");
            exit();
        } else {
            header("Location: outiau.php?ID=" . urlencode($id) . "&msg=Error+Edited&status=failed");
            exit();
        }
    }
}
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-inline-block text-truncate" style="max-width:180px;"><?php echo htmlentities($row['CodeId']); ?></div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="d-inline-block text-truncate" style="max-width:180px;" data-bs-toggle="tooltip" title="<?php echo htmlentities($row['OutDepartment']); ?>"><?php echo htmlentities($row['OutDepartment']); ?></div>
                                                    </td>
                                                    <td><?php echo htmlentities($row['NameOFReceive']); ?></td>
                                                    <td>
                                                        <a href="../../uploads/file/out-doc/<?php echo htmlentities($row['Typedocument']); ?>" target="_blank" class="btn-sm btn-link h6 mb-0 text-primary">ពិនិត្យមើលឯកសារ</a>
                                                    </td>
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="formAccountSettings" method="post">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="mb-3 col-md-6">
                                                                            <label for="nameofgive" class="form-label">ឈ្មោះមន្រ្តីប្រគល់</label>
                                                                            ...
                                                                            <div class="input-group">
                                                                                <div class="input-group-append">
                                                                                    <div class="d-flex justify-content-between p-2 rounded-3">
                                                                                        <a href="../../uploads/file/out-doc/<?php echo htmlentities($row['Typedocument']); ?>" target="_blank" class="btn-sm btn-link h6 mb-0">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="formAccountSettings" method="post" enctype="multipart/form-data">
                                                                    <div class="row">
                                                                        ...
                                                                        <input type="hidden" name="nameofgive" value="<?php echo htmlentities($row['NameOfgive']); ?>"> <!-- Hidden input for Name of give -->
